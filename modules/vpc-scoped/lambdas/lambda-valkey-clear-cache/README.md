...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_iam_role_lambda_valkey_clear_cache"></a> [iam\_role\_lambda\_valkey\_clear\_cache](#module\_iam\_role\_lambda\_valkey\_clear\_cache) | terraform-aws-modules/iam/aws//modules/iam-role | 6.4.0 |
| <a name="module_lambda_valkey_clear_cache"></a> [lambda\_valkey\_clear\_cache](#module\_lambda\_valkey\_clear\_cache) | terraform-aws-modules/lambda/aws | ~> 8.0 |

## Resources

| Name | Type |
|------|------|
| [archive_file.lambda_valkey_clear_cache](https://registry.terraform.io/providers/hashicorp/archive/latest/docs/data-sources/file) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_iam_role_lambda_valkey_clear_cache"></a> [iam\_role\_lambda\_valkey\_clear\_cache](#output\_iam\_role\_lambda\_valkey\_clear\_cache) | n/a |

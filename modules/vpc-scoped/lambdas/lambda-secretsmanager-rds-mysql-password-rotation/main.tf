############################################################
# Lambda Secretsmanager RDS MySQL Password Rotation       🇧🇷
############################################################

data "archive_file" "lambda_secretsmanager_rds_mysql_password_rotation" {
  type        = "zip"
...
locals {
  lambda_function_name                      = "${var.resource_prefix}-secretsmanager-rds-mysql-password-rotation"
...
module "lambda_secretsmanager_rds_mysql_password_rotation" {
  ...
  create_role                             = false
  lambda_role                             = module.iam_role_lambda_secretsmanager_rds_mysql_password_rotation.arn
  create_package                          = false
  create_current_version_allowed_triggers = false
  local_existing_package                  = data.archive_file.lambda_secretsmanager_rds_mysql_password_rotation.output_path

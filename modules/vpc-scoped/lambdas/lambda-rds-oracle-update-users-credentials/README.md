...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_iam_role_lambda_rds_oracle_update_users_credentials"></a> [iam\_role\_lambda\_rds\_oracle\_update\_users\_credentials](#module\_iam\_role\_lambda\_rds\_oracle\_update\_users\_credentials) | terraform-aws-modules/iam/aws//modules/iam-role | 6.4.0 |
| <a name="module_lambda_rds_oracle_update_users_credentials"></a> [lambda\_rds\_oracle\_update\_users\_credentials](#module\_lambda\_rds\_oracle\_update\_users\_credentials) | terraform-aws-modules/lambda/aws | ~> 8.0 |

## Resources

| Name | Type |
|------|------|
| [archive_file.lambda_rds_oracle_update_users_credentials](https://registry.terraform.io/providers/hashicorp/archive/latest/docs/data-sources/file) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_iam_role_lambda_rds_oracle_update_users_credentials"></a> [iam\_role\_lambda\_rds\_oracle\_update\_users\_credentials](#output\_iam\_role\_lambda\_rds\_oracle\_update\_users\_credentials) | n/a |

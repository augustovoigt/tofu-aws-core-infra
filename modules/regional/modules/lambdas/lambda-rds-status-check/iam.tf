module "iam_role_lambda_rds_status_check" {
  ...
  inline_policy_permissions = {
    RDSStatusCheckAccess = {
      sid     = "RDSStatusCheckAccessPolicy"
      effect  = "Allow"
      actions = ["rds:DescribeDBInstances", "rds:DescribeDBSnapshots", "rds:StartDBInstance"]
      resources = [

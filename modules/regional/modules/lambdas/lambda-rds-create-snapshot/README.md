...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_iam_role_lambda_rds_create_snapshot"></a> [iam\_role\_lambda\_rds\_create\_snapshot](#module\_iam\_role\_lambda\_rds\_create\_snapshot) | terraform-aws-modules/iam/aws//modules/iam-role | 6.4.0 |
| <a name="module_lambda_rds_create_snapshot"></a> [lambda\_rds\_create\_snapshot](#module\_lambda\_rds\_create\_snapshot) | terraform-aws-modules/lambda/aws | ~> 8.0 |

## Resources

| Name | Type |
|------|------|
| [archive_file.lambda_rds_create_snapshot](https://registry.terraform.io/providers/hashicorp/archive/latest/docs/data-sources/file) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_iam_role_lambda_rds_create_snapshot"></a> [iam\_role\_lambda\_rds\_create\_snapshot](#output\_iam\_role\_lambda\_rds\_create\_snapshot) | n/a |
